const { getFormattedAtendentes, getFormattedFinanceiro } = require('./fileUtils');
...
module.exports = { handleMainMenuSelection, handlePedidosSubMenu, handlePedido, handleDuvidasOuProblemas };
